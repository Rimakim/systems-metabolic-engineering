...
def argument_parser(version=None):
    ...
    parser.add_argument('-str', '--regulation_strength', required=False, type=float,
                        default=0.5, 
                        help='Flux regulation strength')
    
    parser.add_argument('-e', '--eps', required=False, type=float,
                        default=0.0005, 
    ...
    parser.add_argument('-f_opt', '--fraction_of_optimum', required=False, type=float, 
                        default=0.95, 
